					...
					<div className="item">
						<a href="#" className={styles.card}>
							...
							<div className="column-2">
								...
								<p>
									With this powerful WooCommerce plugin, you can easily design
									...
									of creating professional-looking documents that perfectly
									match your brand. Our plugin streamlines the entire invoicing
									and packing slip creation process, saving you valuable time.
									Try our plugin today and take your invoicing to the next
									level!
								</p>
